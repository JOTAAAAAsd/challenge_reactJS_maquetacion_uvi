...
export const HomeSection = () => {
    ...
    const titles = [
        "Servicios para la inserción",
        "Seguimiento profesional",
        "Asesoramiento personalizado"
    ];

    const description = [
        "Estamos cualificados para guiarte en tu proceso",
        "Te acompañamos en el cumplimiento de tus objetivos",
        "Te garantizamos la asesoría que te mereces de la mano de nuestros expertos"
    ];
